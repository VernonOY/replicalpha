        ...
        <div style={{flex:1, display:'flex', flexDirection:'column', minWidth:0}}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              {(() => {
                const tabLabels = { terminal: window.t("ide.tab.terminal"), problems: window.t("ide.tab.problems"), output: window.t("ide.tab.output"), llm: window.t("ide.tab.llm") };
                return ['terminal','problems','output','llm'].map(t => (
            ...
            <div style={{flex:1, overflow:'auto', padding:'8px 14px', fontFamily:'var(--mono)', fontSize:11.5, lineHeight:1.6}}>
